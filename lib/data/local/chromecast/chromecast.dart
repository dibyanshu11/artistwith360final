...
// final Logger log = Logger('Chromecast CLI');

// void mains(List<String> arguments, BuildContext context) async {
...
//     //         // ignore: use_build_context_synchronously
//     //         .showSnackBar(snackBar(context, 'No devices found!'));
...
//   } catch (e) {
//     // does not exist yet
//     log.warning('error fetching saved state$e');
//   }
