...
class _MyListScreenState extends State<MyListScreen> {
  ...
  @override
  void initState() {
    pageCountValueList = 1;
    getPaginationData.removeRange(0, getPaginationData.length);
          ...
          return Scaffold(
              ...
              body: state is SuccessState
                  ? Padding(
                      ...
                      child: state.myListModel.data!.listing!.length.toInt() !=
                              0
                          ? SingleChildScrollView(
                              ...
                              child: Column(
                                children: [
                                  GridView.builder(
                                      ...
                                      gridDelegate:
                                          const SliverGridDelegateWithMaxCrossAxisExtent(
                                              ...
                                              crossAxisSpacing: 30,
                                              mainAxisSpacing: 0),
                                      itemCount: getPaginationData.length,
                                      padding: const EdgeInsets.only(
                                        top: 25,
                                      ),
                                      itemBuilder:
                                          (BuildContext context, index) {
                                        var store = getPaginationData[index];
                                        return Padding(
                                          padding:
                                  ...
                                  state.myListModel.data!.lastPage! >
                                          pageCountValueList
                                      ? indiator(Colors.white)
                                      : Text(
                                          'No More Data',
